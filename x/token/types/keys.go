...
var (
	...
	FreezeKey = []byte{0x02} // the address prefix of the freeze coins

	LockKey = []byte{0x03} // the address prefix of the locked coins
)
...
func GetFreezeAddress(addr sdk.AccAddress) []byte {
	return append(FreezeKey, addr.Bytes()...)
}
